...
The built-in print function is a great way to transfer information from your code to the console. You can use print statements to give instructions, present output, or even to check that your code is working as expected. Let's start by using print for creative output: telling a story.
